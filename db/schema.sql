...
DELIMITER $$ CREATE TRIGGER one_row
...
CREATE TABLE IF NOT EXISTS Category (
    ...
    FOREIGN KEY (Parent_Category_ID) REFERENCES Category (Category_ID) ON UPDATE CASCADE ON DELETE SET NULL) ENGINE = InnoDB;
CREATE TABLE IF NOT EXISTS Items (
    ...
    FULLTEXT (brand,
              name),
    FOREIGN KEY (Category_ID) REFERENCES Category (Category_ID) ON UPDATE CASCADE ON DELETE SET NULL) ENGINE = InnoDB;
